 ...
 */
#if DSP_ALU_INT
static inline dspALU_t dsp_calc_fir_int(  dspALU_t ALU,               // original Accumulator when enterring fir contains xn sample in 0.31
...
#elif DSP_ALU_FLOAT
static inline dspALU_t dsp_calc_fir_float(dspALU_SP_t xn,
